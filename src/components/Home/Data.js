...
const Data = () => {
  return (
    <div className='home__data'>
      <h1 className='home__title'>Shaker Sarwar
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <p className='home_description'>I'm a Front-End Developer Skilled in Html, CSS, Bootstrap, Tailwind CSS, Javascript, jQuery, React js, Next js, and Gatsby. I Have Experience With Responsive Design Using multiple Frameworks. I'm Also Familiar with Figma, PhotoShop, and Illustrator & I'm Capable Of converting Mockups to pixel-perfect Html or Functional Websites</p>
